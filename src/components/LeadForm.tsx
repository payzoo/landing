...
const LeadForm = () => {
  ...
  return (
    <div id="signup" className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl p-6 border border-white/20 relative overflow-hidden max-w-md mx-auto">
      ...
      <div className="relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button
            ...
            className="w-full bg-gradient-to-r from-[#B4DE00] to-[#9BC400] hover:from-[#9BC400] hover:to-[#8AB300] text-black py-3 h-12 rounded-lg font-semibold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl"
          >
            {isSubmitting ? (
